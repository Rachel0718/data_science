...
二、統計所有文章標題有提到iPhone XS,iPhone XS MAX,iPhone XR的數量(dataframe)
...
pttMobileComm_1
library(knitr)
kable(pttMobileComm_1)

```

二、統計所有文章標題有提到iPhone X,iPhone 8,iphone 8 plus的數量(dataframe)
